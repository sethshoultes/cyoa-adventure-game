...
FartCoin: 10
Inventory: - Rusty Sword - Tattered Cloak - Healing Potion - Traveler's Backpack - Torch - Map of FartMan's Kingdom
Abilities: - Persuasion: 8 - Strength: 12 - Intelligence: 15 - Dexterity: 10 - Luck: 14
Quest: None
Possible Commands:
1. Prepare to set off for the Whispering Woods
...
The player chose: $user_command. What happens next?";
    ...
    // Prepare API request
    $role = "Please perform the function of a text adventure game, following the rules listed below:

    Presentation Rules:

    1. Play the game in turns, starting with you.

    2. The game output will always show 'Turn number', 'Time period of the day', 'Current day number', 'Weather', 'Health', 'XP', 'AC', 'Level', 'Location', 'Description', 'FartCoin', 'Inventory', 'Quest', 'Abilities', and 'Possible Commands'.

    3. Always wait for the player’s next command.

    4. Stay in character as a text adventure game and respond to commands the way a text adventure game should.

    5. The 'Location' must be a place in the FartMan universe.
    ...
    13. The only currency in this game is FartCoin.

    14. The value of 'FartCoin' must never be a negative integer.

    15. The player can not spend more than the total value of 'FartCoin'.

    Rules for Setting:

    1. Use the world of FartMan as inspiration for the game world. Import whatever weapons, villains, and items that the FartMan Universe has.
    ...
    Combat and Fart Power Rules:

    1. Import super-powered flatulence into this game from Traveller 5th Edition.

    2. Fart Power (magic) can only be cast if the player has the corresponding magic scroll in their inventory.

    3. Using fart power will drain the player character’s health. More powerful fart power will drain more health.
...
function wp_adventure_game_chatgpt_version_callback() {
    ...
    <select id="wp_adventure_gamechatgpt_version" name="wp_adventure_gamechatgpt_version">
        <option value="gpt-3.5-turbo" <?php selected($chatgpt_version, 'gpt-3.5-turbo'); ?>>GPT-3.5 Turbo</option>
        <option value="gpt-4" <?php selected($chatgpt_version, 'gpt-4'); ?>>GPT-4</option>
        <option value="gpt-4o-mini" <?php selected($chatgpt_version, 'gpt-4o-mini'); ?>>GPT-4o Mini</option>
        <option value="gpt-4o-turbo" <?php selected($chatgpt_version, 'gpt-4o-turbo'); ?>>GPT-4o Turbo</option>
        <option value="chatgpt-4o-latest" <?php selected($chatgpt_version, 'chatgpt-4o-latest'); ?>>Chatgpt-4o Latest</option>
        <option value="text-embedding-3-small" <?php selected($chatgpt_version, 'text-embedding-3-small'); ?>>text-embedding-3-small</option>
    </select>
